...
async def register_store(
    ...
    if not re.match(
        ...
        raise HTTPException(
            status_code=400,
            detail=(
                "اسم المستخدم يجب أن يحتوي "
                "على أحرف أو أرقام أو _ أو - أو . فقط."
            ),
        )
...
async def ensure_evolution_instance(
    ...
    try:
        ...
        # إذا كان الخطأ غير متعلق بوجود Instance
        ...
        # لا نوقف العملية هنا.
        # سنحاول الاتصال بالـ instance الموجودة.
        pass
